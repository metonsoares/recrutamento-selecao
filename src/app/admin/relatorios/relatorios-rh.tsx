...
import {
  FeriasRegistro, StatusFerias, situacaoFerias,
  hoje, paraData, formatarData, somarDias, diasEntre,
} from '@/lib/ferias'
...
// Regra de férias (períodos aquisitivo/concessivo): src/lib/ferias.ts
